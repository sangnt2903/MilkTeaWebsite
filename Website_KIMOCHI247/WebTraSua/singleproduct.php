...
<html lang="en">
  ...
  <body>
                ...
                <div class="col-md-4">
                    <div class="single-sidebar">
                        ...
                        <form action="">
                            ...
                            <input type="button" value="Tìm kiếm" name="OK" id="btnSearch">
                        </form>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <form action="" class="cart" align ="center">
                                        ...
                                        if(isset($_SESSION['makh'])){
                                           ?>
                                            <a href="xuly_cart.php?makh=<?=$_SESSION['makh']?>&mahh=<?=$chitiettrasua->mahh?>" ><span>Thêm vào giỏ</span></a>
                                           <?php 
                                        } else{
                                            ?>
                                                <a href="#" ><span>Thêm vào giỏ</span></a>
                                            <?php
                                        }
                                    ?>
                                    </form>   
    ...
    <!-- Comments Form -->
    <div class="col-md-12 tabpanel pull-left">
                        <?php
