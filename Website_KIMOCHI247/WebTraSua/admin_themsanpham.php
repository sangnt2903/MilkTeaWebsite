<?php
	...
	if(isset($_POST['them'])){
			if($_POST['tenhh'] == "" || $_POST['hinh'] == "" || $_POST['tomtat'] == "" || $_POST['giatien'] == ""|| $_POST['soluong'] == ""){
					$thongbao = "Không thể để trống các trường trên.";
					if(isset($_SESSION['them_sp'])){
						unset($_SESSION['them_sp']);
					}
			}else if(!is_numeric($_POST['giatien']) || !is_numeric($_POST['soluong'])){
				...
				$them_ts = $c_TraSua -> themSanPham($tenhh,$hinh,$tomtat,$giatien,$soluong);  
			}
		}
						...
						<form action="#" method ="POST">
							...
							<table align="center">
								...
								<tr>
									...
									<td><input type="text" class="form-control" placeholder="Hình ảnh" name="hinh" aria-describedby="basic-addon1"
	                                ></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" class="form-control" name="soluong" aria-describedby="basic-addon1"placeholder="Số lượng"></td>
								</tr>
								<tr>
